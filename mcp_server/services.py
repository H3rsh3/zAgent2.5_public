...
class TenantService(BaseService):
    ...
    def __init__(self):
        super().__init__()
        from tools.tenantmgmt.list_tenants import list_tenants

        self.read_tools = [
            {"func": list_tenants, "name": "list_tenants", "description": "List all configured Zscaler tenants from the database (read-only)"},
        ]
        self.write_tools = []

    def register_tools(self, server, enabled_tools=None, enable_write_tools=False, write_tools=None):
        """Register Tenant Management tools with the server."""
        from mcp_server.common.tool_helpers import register_read_tools, register_write_tools
        ...
        logger.info(f"Tenant Service: Registered {read_count} read tools, {write_count} write tools")
...
class ZIdentityService(BaseService):
    ...
    def __init__(self):
        ...
        from mcp_server.tools.zidentity.groups import (
            zidentity_get_group,
        ...
        from mcp_server.tools.zidentity.users import (
            zidentity_get_user,
...
class ZDXService(BaseService):
    ...
    def __init__(self):
        super().__init__()
        # Import ZDX tools (mostly read-only)
        from mcp_server.tools.zdx import (
            zdx_get_alert,
            zdx_get_application,
        ...
        # All current ZDX tools are read-only
        self.read_tools = [
            {"func": zdx_list_devices, "name": "zdx_list_devices", "description": "Lists ZDX devices with optional filtering (read-only)"},
            {"func": zdx_get_device, "name": "zdx_get_device", "description": "Gets detailed information for a specific ZDX device (read-only)"},
            {"func": zdx_list_departments, "name": "zdx_list_departments", "description": "Lists ZDX departments (read-only)"},
            {"func": zdx_list_locations, "name": "zdx_list_locations", "description": "Lists ZDX locations (read-only)"},
            {"func": zdx_list_applications, "name": "zdx_list_applications", "description": "Lists active ZDX applications (read-only)"},
            {"func": zdx_get_application_metric, "name": "zdx_get_application_metric", "description": "Retrieves ZDX metrics for a specific application (read-only)"},
            {"func": zdx_get_application, "name": "zdx_get_application", "description": "Gets ZDX score information for a specific application (read-only)"},
            {"func": zdx_get_application_score_trend, "name": "zdx_get_application_score_trend", "description": "Gets ZDX score trend for a specific application (read-only)"},
            {"func": zdx_list_application_users, "name": "zdx_list_application_users", "description": "Lists users and devices that accessed a specific ZDX application (read-only)"},
            {"func": zdx_get_application_user, "name": "zdx_get_application_user", "description": "Gets detailed information for a specific user accessing an application (read-only)"},
            {"func": zdx_list_alerts, "name": "zdx_list_alerts", "description": "Lists all ongoing ZDX alert rules across an organization (read-only)"},
            {"func": zdx_get_alert, "name": "zdx_get_alert", "description": "Gets detailed information for a specific ZDX alert (read-only)"},
            {"func": zdx_list_alert_affected_devices, "name": "zdx_list_alert_affected_devices", "description": "Lists all devices affected by a specific ZDX alert (read-only)"},
            {"func": zdx_list_device_deep_traces, "name": "zdx_list_device_deep_traces", "description": "Lists all deep traces for a specific ZDX device (read-only)"},
            {"func": zdx_get_device_deep_trace, "name": "zdx_get_device_deep_trace", "description": "Gets detailed information for a specific deep trace (read-only)"},
            {"func": zdx_list_historical_alerts, "name": "zdx_list_historical_alerts", "description": "Retrieves ZDX historical alert information (read-only)"},
            {"func": zdx_list_software, "name": "zdx_list_software", "description": "Lists all software in the ZDX inventory (read-only)"},
            {"func": zdx_get_software_details, "name": "zdx_get_software_details", "description": "Gets detailed information about a specific software including all users and devices (read-only)"},
        ]

        self.write_tools = []  # ZDX has no write operations currently
...
class ZInsightsService(BaseService):
    ...
    def __init__(self):
        super().__init__()
        # Import Z-Insights tools (all read-only)
        from mcp_server.tools.zinsights import (
        ...
        self.read_tools = [
            {"func": zinsights_get_web_traffic_by_location, "name": "zinsights_get_web_traffic_by_location", "description": "Get web traffic analytics grouped by location (read-only)"},
            {"func": zinsights_get_web_traffic_no_grouping, "name": "zinsights_get_web_traffic_no_grouping", "description": "Get overall web traffic analytics without grouping (read-only)"},
            {"func": zinsights_get_web_protocols, "name": "zinsights_get_web_protocols", "description": "Get web traffic analytics by protocol (read-only)"},
            {"func": zinsights_get_threat_super_categories, "name": "zinsights_get_threat_super_categories", "description": "Get threat super category analytics from web traffic (read-only)"},
            {"func": zinsights_get_threat_class, "name": "zinsights_get_threat_class", "description": "Get threat class analytics from web traffic (read-only)"},
            {"func": zinsights_get_cyber_incidents, "name": "zinsights_get_cyber_incidents", "description": "Get cybersecurity incidents grouped by category (read-only)"},
            {"func": zinsights_get_cyber_incidents_by_location, "name": "zinsights_get_cyber_incidents_by_location", "description": "Get cybersecurity incidents grouped by location (read-only)"},
            {"func": zinsights_get_cyber_incidents_daily, "name": "zinsights_get_cyber_incidents_daily", "description": "Get daily cybersecurity incidents over time (read-only)"},
            {"func": zinsights_get_cyber_incidents_by_threat_and_app, "name": "zinsights_get_cyber_incidents_by_threat_and_app", "description": "Get cybersecurity incidents grouped by threat and app (read-only)"},
            {"func": zinsights_get_firewall_by_action, "name": "zinsights_get_firewall_by_action", "description": "Get firewall traffic grouped by action (read-only)"},
            {"func": zinsights_get_firewall_by_location, "name": "zinsights_get_firewall_by_location", "description": "Get firewall traffic grouped by location (read-only)"},
            {"func": zinsights_get_firewall_network_services, "name": "zinsights_get_firewall_network_services", "description": "Get firewall traffic by network service (read-only)"},
            {"func": zinsights_get_casb_app_report, "name": "zinsights_get_casb_app_report", "description": "Get CASB application usage report (read-only)"},
            {"func": zinsights_get_shadow_it_apps, "name": "zinsights_get_shadow_it_apps", "description": "Get discovered Shadow IT applications with details (read-only)"},
            {"func": zinsights_get_shadow_it_summary, "name": "zinsights_get_shadow_it_summary", "description": "Get comprehensive Shadow IT summary statistics (read-only)"},
            {"func": zinsights_get_iot_device_stats, "name": "zinsights_get_iot_device_stats", "description": "Get IoT device statistics and classifications (read-only)"},
        ]
